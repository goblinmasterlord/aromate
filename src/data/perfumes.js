export const perfumes = [
    ...
    },
    {
      ...
      tags: ["fresh", "citrus", "clean", "versatile"],
      rating: 4.2
    },
    {
      id: 31,
      ...
      tags: ["fresh", "aromatic", "sporty", "clean"],
      rating: 4.3
    },
    {
      id: 32,
    ...
    },
    {
      ...
      tags: ["fresh", "aquatic", "marine", "aromatic"],
      rating: 4.5
    },
    {
      id: 36,
      ...
      year: 2021,
      season: ["all"],
      occasion: ["evening", "special", "casual"],
      notes: {
        top: ["cinnamon", "nutmeg", "cardamom", "grapefruit"],
        middle: ["lavender", "Licorice", "sandalwood"],
        base: ["Haitian vetiver", "patchouli", "amber woods"]
      },
      characteristics: {
        longevity: 9,
        sillage: 8,
      ...
      tags: ["fresh", "spicy", "woody", "intense"],
      rating: 4.7
    },
    {
      id: 37,
      ...
      notes: {
        top: ["red berries", "pimento berries", "black pepper"],
        middle: ["cinnamon leaf", "red pepper", "cumin"],
        base: ["tobacco", "benzoin", "guaiac wood"]
      },
      characteristics: {
        longevity: 7,
        sillage: 7,
      ...
      tags: ["spicy", "warm", "sweet", "seductive"],
      rating: 4.4
    },
    {
      id: 38,
      ...
      notes: {
        ...
        base: ["madagascar vanilla", "vetiver", "oakmoss", "cedar"]
      },
      characteristics: {
        longevity: 7,
        sillage: 7,
